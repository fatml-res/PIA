...
for tp1 in tps:
    ...
    for ft in fts:
        ...
        ff = "./{}/{}-99-5-12-13-{}.pkl".format(tp, ft,tp1)
...
result.to_csv("{}/results_transfer.csv".format(res_dir))
...
name = ['name','acc', 'recall', 'precision', 'f1', 'auc']
result = pd.DataFrame(columns=name, data=results)
result.to_csv("{}/results_transfer-interintra.csv".format(res_dir))